...
import com.krunal.brain.Adapters.TodoAdapter;
...
public class TodoIdeasFragment extends Fragment {
    ...
    public static TodoIdeasFragment newInstance() {
        TodoIdeasFragment fragment = new TodoIdeasFragment();
        return fragment;
    }
    ...
    private void initList() {
        todoAdapter = new TodoAdapter(getActivity(), arrayUserTodos , "" + new PreferenceManager(getActivity()).getUsername());
    ...
    public void initialization(){
        ...
        client.get(RequestUrl.GET_TODO_URL + new PreferenceManager(getActivity()).getUsername() + "/todos", new AsyncHttpResponseHandler() {
